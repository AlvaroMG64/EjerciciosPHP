...
<form method="post" onsubmit="return validarTriangulo()">
    <label>Lado A: <input type="number" id="ladoA" name="ladoA" step="0.01" required></label>
    <label>Lado B: <input type="number" id="ladoB" name="ladoB" step="0.01" required></label>
    <label>Lado C: <input type="number" id="ladoC" name="ladoC" step="0.01" required></label>
